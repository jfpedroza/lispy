...
std::string div_zero();
std::string int_mod();
std::string sexpr_not_function(LValue::Type got);
std::string mismatched_num_args(const std::string &func, size_t got,
                                size_t expected);
std::string too_many_args(size_t got, size_t expected);
std::string passed_incorrect_type(const std::string &func, LValue::Type got,
                                  LValue::Type expected);
std::string passed_incorrect_type(const std::string &func, LValue::Type got,
                                  std::initializer_list<LValue::Type> expected);
std::string passed_nil_expr(const std::string &func);
std::string passed_empty_string(const std::string &func);
std::string cant_define_non_sym(const std::string &func, LValue::Type got);
std::string cant_define_mismatched_values(const std::string &func);
std::string function_format_invalid();
std::string could_not_load_library(const std::string &msg);
} // namespace lerr
